...
Lx = 1
Ly = Lx
F = Euler(5. / 3, dim=DIM, c1=0.1, c2=0., hx=Lx / resolution[0], hy=Ly / resolution[1], add_viscosity=False)
...
plotter = Plotter(5, action="show", writeout=100, dim=stepper.dim, filename="gresho_vortex_iml_100_hybr_eps1e-9.mp4")
